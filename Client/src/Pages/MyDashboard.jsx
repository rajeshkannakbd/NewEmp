...
export default function MyDashboard() {
  ...
  const gross = employee ? totalShifts * employee.shiftRate + overtimePay : 0;
    ...
    <div className="max-w-5xl mx-auto p-4 space-y-4">
      ...
      {employee && (
        <div className="bg-white p-4 rounded shadow">
          ...
          <div>
            <strong>Shift Rate:</strong> ₹{employee.shiftRate}
          </div>
          <div>
      ...
      <div className="bg-white p-4 rounded shadow">
        ...
        <div className="font-bold text-xl mt-2">Net Salary: ₹{net}</div>
      </div>
    </div>
  );
}
